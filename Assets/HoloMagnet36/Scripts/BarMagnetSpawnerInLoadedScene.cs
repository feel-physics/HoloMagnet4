...
namespace FeelPhysics.HoloMagnet36
{
    ...
    /// </summary>
    public class BarMagnetSpawnerInLoadedScene : MonoBehaviour
    {
        /// <summary>
        ...
        private void Start()
        {
            ...
            // PrefabSpawnManagerの初期化が終わってから棒磁石を生成する
            MyHelper.MyDelayMethod(this, 1f, () =>
            {
                this.CreateMagnet(this.myUserId);
                var magnetToDelete = GameObject.FindGameObjectWithTag("Bar Magnet");
                UnityEngine.Object.DestroyImmediate(magnetToDelete);
            });
        }
        ...
        private void CreateMagnet(long userId)
        {
            ...
            this.spawnManager.Spawn(spawnedObject, position, rotation, spawnParentTransform.gameObject, "SpawnedBarMagnet", true);
        }
